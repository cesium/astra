...
export default function ExchangeDrafts() {
  ...
  const data = [
    {
      uc: "Álgebra Linear Aplicada A Matrizes Para Inteligência Artificial",
      from: "TP1",
      to: "TP2",
    },
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <button className="bg-celeste hover:bg-celeste/90 flex w-fit cursor-pointer items-center gap-2 rounded-xl px-4 py-2 text-white">
        <span
          className="material-symbols-outlined"
          style={{ fontSize: "24px" }}
        >
